...
private Stage stage;
/*
  Basically in the runner code, we are switching scenes and in order to do that we must set Scene 
  and Stage as private fields in order to be able to readily refer to them throughout the 
  program.  We created two methods which allows us to switch scenes, thereby giving the allusion
 ...
 */
   ...
   //opens the main menu
    ...
    {
    	/* We decided to use Stackpane over Group to be able to rearange the order of nodes to
	...
	/*The select class is hover buttons that take in a button, (x,y) coordinates, the original image
	 * and hued version of the original image. By switching back and forth, we are providing the
	 * allusion of hovering.  And in the Select class, the buttons are changed to different
	 * graphics in order to accomplish this.  The x and y coordinates are determined by trial and 
	 * error as well as this helpful method revealed later on that gives you the coordinates when you click
	 ...
	 */
		...
		/*
		 * The mouse gets clicked and calls the method loadScreenTwo which loads to another scene.  
		 * Although the scenes of the regions may seem consistent, they are unique by their images, feuatures, and audio as indicated by the 
		 * parameters that the function takes in.  By using these parameters, the function allows the scene to be unique to the region
		 */
		button1.getButton().addEventHandler(MouseEvent.MOUSE_CLICKED,
		        new EventHandler<MouseEvent>() {
		          ...
		          public void handle(MouseEvent e) {
		      		  ...
		      		  button1.getButton().getScene().setRoot(loadScreenTwo("images/Northern_Africa.jpg",0,"North","C:\\\\Users\\\\BT_1N3_06\\\\git\\\\Java-Application\\\\All Around the World of Africa\\\\src\\\\Alice.mp3"));  
		          }
		        });
		button2.getButton().addEventHandler(MouseEvent.MOUSE_CLICKED,
		        new EventHandler<MouseEvent>() {
		          ...
		          public void handle(MouseEvent e) {
		        	  button1.getButton().getScene().setRoot(loadScreenTwo("images/Western_Africa.jpg",1,"West","C:\\\\Users\\\\BT_1N3_06\\\\git\\\\Java-Application\\\\All Around the World of Africa\\\\src\\\\Alice.mp3")); 
		...
		button3.getButton().addEventHandler(MouseEvent.MOUSE_CLICKED,
		        new EventHandler<MouseEvent>() {
		          ...
		          public void handle(MouseEvent e) {
		        	  button1.getButton().getScene().setRoot(loadScreenTwo("images/Souther_Africa.jpg",3,"South","C:\\\\Users\\\\BT_1N3_06\\\\git\\\\Java-Application\\\\All Around the World of Africa\\\\src\\\\Alice.mp3")); 
		          }
		        });
		button4.getButton().addEventHandler(MouseEvent.MOUSE_CLICKED,
		        new EventHandler<MouseEvent>() {
		          ...
		          public void handle(MouseEvent e) {
		        	  button1.getButton().getScene().setRoot(loadScreenTwo("images/Eastern_Africa.jpg",2,"East","C:\\\\Users\\\\BT_1N3_06\\\\git\\\\Java-Application\\\\All Around the World of Africa\\\\src\\\\Alice.mp3")); 
		...
		button5.getButton().addEventHandler(MouseEvent.MOUSE_CLICKED,
		        new EventHandler<MouseEvent>() {
		          ...
		          public void handle(MouseEvent e) {
		        	  button1.getButton().getScene().setRoot(loadScreenTwo("images/Central_Africa.jpg",4,"Central","C:\\\\Users\\\\BT_1N3_06\\\\git\\\\Java-Application\\\\All Around the World of Africa\\\\src\\\\Alice.mp3")); 
		          }
		        });
		...
		wahoo.addEventHandler(MouseEvent.MOUSE_CLICKED,
	          ...
	          public void handle(MouseEvent e) {
	        	   ...
	        	   * by passing the url through the parameter and it is triggered when the user
	        	   * clicks on wahoo rat
	        	   */
    ...
    public StackPane loadScreenTwo(String image, int index, String name,String url)
    {
    	StackPane vBox = new StackPane();
        vBox.setAlignment(Pos.CENTER);
